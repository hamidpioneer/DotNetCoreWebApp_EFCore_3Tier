...
namespace DAL.Migrations
{
    ...
    [Migration("20210727174948_DateTim.UtcNow")]
    partial class DateTimUtcNow
    {
            ...
            modelBuilder.Entity("DAL.Models.Applicant", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 7, 27, 17, 49, 47, 828, DateTimeKind.Utc).AddTicks(6560))
            ...
            modelBuilder.Entity("DAL.Models.Application", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 17, 49, 47, 851, DateTimeKind.Utc).AddTicks(9542))
                        .HasColumnName("creation_date");
            ...
            modelBuilder.Entity("DAL.Models.ApplicationStatus", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 17, 49, 47, 850, DateTimeKind.Utc).AddTicks(2284))
                        .HasColumnName("creation_date");
            ...
            modelBuilder.Entity("DAL.Models.Grade", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 7, 27, 17, 49, 47, 851, DateTimeKind.Utc).AddTicks(4041))
                        .HasColumnName("creation_date");
